...
public class NhanVien extends JPanel {
    ...
    public void initComponent() {
        ...
        searchfunc = new IntegratedSearch(
                new String[] { "----", "mã", "tên", "số điện thoại", "giới tính", "chức vụ" });
        ...
        dataTabelModel
                .setColumnIdentifiers(new String[] { "MÃ NV", "Tên NV", "Số điện thoại", "Giới tính", "Chức vụ" });
